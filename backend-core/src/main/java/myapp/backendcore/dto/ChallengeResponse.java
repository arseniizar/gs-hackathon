...
import myapp.backendcore.model.Challenge.DataAsset;
...
public class ChallengeResponse {
    ...
    // ПОВНИЙ КОНСТРУКТОР
    public ChallengeResponse(String id, String title, String description, ChallengeStatus status, String metric, Instant deadline, String rules, List<DataAsset> dataAssets, Instant createdAt, Instant updatedAt) {
        this.id = id;
        this.title = title;
    ...
    public static final class Builder {
        ...
        public Builder rules(String rules) { this.rules = rules; return this; }
        public Builder dataAssets(List<DataAsset> dataAssets) { this.dataAssets = dataAssets; return this; }
        public Builder createdAt(Instant createdAt) { this.createdAt = createdAt; return this; }
        public Builder updatedAt(Instant updatedAt) { this.updatedAt = updatedAt; return this; }

        public ChallengeResponse build() {
            return new ChallengeResponse(id, title, description, status, metric, deadline, rules, dataAssets, createdAt, updatedAt);
        }
    }
}